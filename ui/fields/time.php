...
if ( 1 == filters_var( 'time_html5', $options ) )
    $type = $date_type;

$attributes[ 'type' ] = $type;
$attributes[ 'tabindex' ] = 2;

$format = FiltersForm::field_method( 'time', 'format', $options );

$method = 'timepicker';

$args = array(
    'timeFormat' => $time_format[ filters_var( 'time_format', $options, 'h_mma', null, true ) ]
);
...
if ( 24 == filters_var( 'time_type', $options, 12 ) )
    $args[ 'ampm' ] = false;

$date = FiltersForm::field_method( 'time', 'createFromFormat', $format, (string) $value );
$date_default = FiltersForm::field_method( 'time', 'createFromFormat', 'H:i:s', (string) $value );

if ( 'text' != $type && ( 0 == filters_var( 'time_allow_empty', $options, 1 ) || !in_array( $value, array( '0000-00-00', '0000-00-00 00:00:00', '00:00:00' ) ) ) ) {
...
$args = apply_filters( 'filters_form_ui_field_time_args', $args, $type, $options, $attributes, $name, FiltersForm::$field_type );
